...
const contractSchema = z.object({
  ...
  payment_cycle: z.string().optional().default('monthly'),
  status: z.enum(['draft', 'signed', 'active', 'expired', 'terminated', 'renewed']).optional().default('draft'),
...
export const CreateContractForm = ({
  ...
  const handleSubmitForm = async (data: ContractFormData) => {
    try {
      ...
      setError(err instanceof Error ? err.message : 'Lỗi khi tạo hợp đồng');
    }
  };
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-lg max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center p-6 border-b border-gray-200 sticky top-0 bg-white">
          <h2 className="text-xl font-bold text-gray-900">Tạo hợp đồng mới</h2>
